...
if (isset($_SESSION['logged']) && $_SESSION['logged'] == true && isset($_SESSION['rights']) && $_SESSION['rights'] == 1 && isset($_SESSION['idUserModify'])) //Test si l'utilisateur a le droit d'avoir accès à cette page
{
    $modif = new modif($_SESSION['idUserModify'], $bdd);
    $userInfo = $modif->getUserData();
    if (isset($_POST['subModif'])) { //Actions à réaliser si l'utilisateur vient de soumettre le formulaire de modifications
...
<body style="background-image: url('images/background.jpg');background-attachment: fixed;background-position: center center;">
    ...
    <div class="white container z-depth-3" style="margin-top:2%;margin-bottom:2%;padding-top : 2%; padding-bottom : 2%;">
        ...
        <div class="container">
            ...
            <?php if (isset($_SESSION['logged']) && $_SESSION['logged'] == true && isset($_SESSION['rights']) && $_SESSION['rights'] == 1 && isset($_SESSION['idUserModify'])) { //Affichage de la page si l'utilisateur a le droit d'y avoir accès
            ?>
                <div class="row">
                    ...
                    <form method="POST" action="">
                        <div class="row" style="margin-top:5%;">
                            <?php
                            if (isset($message)) { //Affichage d'un message d'erreur pour le formulaire si erreur il y a
                                echo $message;
                            } ?>
                        ...
                        <div class="row">
                            <div class="col s8 offset-s2">
                                ...
                                <select class="browser-default">
                                    <?php if ($userInfo['admin'] == 0) { //Préselectionne les droits actuels de l'utilisateur dans la liste déroulante
