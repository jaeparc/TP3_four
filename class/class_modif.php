...
class modif{
    ...
    public function __construct($id,$bdd)
    {
        ...
        //Fonction retournant les données de l'utilisateur à modifier
    ...
    //Fonction modifiant les données de l'utilisateur à modifier avec les données du formulaire de modif
